...
/* Catálogo — precios propuestos (nivel premium), por confirmar con Rights */
var PRODUCTS = {
  'n60':  { name: 'Nacional 60 %', en: 'Nacional 60 %', price: 3.90, meta: 'Barra 50 g · leche de origen', metaEn: '50 g bar · origin milk' },
  'n70':  { name: 'Nacional 70 %', en: 'Nacional 70 %', price: 3.90, meta: 'Barra 50 g · lote 09', metaEn: '50 g bar · lot 09' },
  'n80':  { name: 'Nacional 80 %', en: 'Nacional 80 %', price: 3.90, meta: 'Barra 50 g', metaEn: '50 g bar' },
  'n100': { name: 'Nacional 100 %', en: 'Nacional 100 %', price: 4.20, meta: 'Barra 50 g · sin azúcar', metaEn: '50 g bar · no sugar' },
  'sal':  { name: 'Sal de Salinas 70 %', en: 'Salinas Salt 70 %', price: 4.50, meta: 'Sabor andino · 50 g', metaEn: 'Andean flavor · 50 g' },
  'cafe': { name: 'Café de Loja 65 %', en: 'Loja Coffee 65 %', price: 4.50, meta: 'Sabor andino · 50 g', metaEn: 'Andean flavor · 50 g' },
  'vuelo': { name: 'Vuelo de cata', en: 'Tasting flight', price: 19.00, meta: '4 × 25 g · 60 / 70 / 80 / 100 % · guía', metaEn: '4 × 25 g · 60 / 70 / 80 / 100 % · guide' },
  'caja3': { name: 'Caja de regalo · 3 barras', en: 'Gift box · 3 bars', price: 18.00, meta: 'Con tarjeta escrita a mano', metaEn: 'With handwritten card' },
  'caja6': { name: 'Caja de regalo · 6 barras', en: 'Gift box · 6 bars', price: 34.00, meta: 'Con tarjeta escrita a mano', metaEn: 'With handwritten card' },
  'lote':  { name: 'Lote numerado 09', en: 'Numbered lot 09', price: 30.00, meta: 'Barra 100 g · 300 unidades · firmada', metaEn: '100 g bar · 300 units · signed' },
  'club':  { name: 'Caja Rights · mensual', en: 'Caja Rights · monthly', price: 10.50, meta: 'Suscripción · 3 barras del lote nuevo', metaEn: 'Subscription · 3 bars from the new lot' },
  'club3': { name: 'Caja Rights · trimestral', en: 'Caja Rights · quarterly', price: 28.50, meta: 'Suscripción · 3 cajas prepagadas', metaEn: 'Subscription · 3 prepaid boxes' }
};
...
(function () {
  ...
  $$('[data-wa]').forEach(function (a) {
    ...
    a.href = wa(kind === 'empresa' ? WHATSAPP_B2B : WHATSAPP_NUMBER, msgs[kind] || msgs.pedido);
  });
