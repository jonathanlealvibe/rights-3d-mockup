...
(function () {
  var D = {
    n60: { title: 'Nacional 60 %', eyebrow: 'Nacional · Guayas · 50 g', price: '$3.90', badge: 'Plata', award: 'Plata — Concurso · Año [DATO RIGHTS]', variant: 'milk', conch: '36 h', ingr: 'Cacao Nacional, azúcar de caña, leche entera en polvo, manteca de cacao. Sin gluten.',
    ...
    n70: { title: 'Nacional 70 %', eyebrow: 'Nacional · Guayas · 50 g', price: '$3.90', badge: 'Oro · lote 09', award: 'Oro — Concurso · Año [DATO RIGHTS]', variant: 'dark', conch: '48 h', ingr: 'Cacao Nacional, azúcar de caña, manteca de cacao. Vegano, sin gluten.',
    ...
    n80: { title: 'Nacional 80 %', eyebrow: 'Nacional · Guayas · 50 g', price: '$3.90', badge: 'Oro', award: 'Oro — Concurso · Año [DATO RIGHTS]', variant: 'intense', conch: '60 h', ingr: 'Cacao Nacional, azúcar de caña, manteca de cacao. Vegano, sin gluten.',
    ...
    n100: { title: 'Nacional 100 %', eyebrow: 'Nacional · Guayas · 50 g · sin azúcar', price: '$4.20', badge: '', award: '', variant: 'intense', conch: '72 h', ingr: 'Cacao Nacional, manteca de cacao. Sin azúcar, vegano, sin gluten.',
    ...
    sal: { title: 'Sal de Salinas 70 %', eyebrow: 'Sabor andino · Guayas + Bolívar · 50 g', price: '$4.50', badge: 'Plata', award: 'Plata — Concurso · Año [DATO RIGHTS]', variant: 'dark', conch: '48 h', ingr: 'Cacao Nacional, azúcar de caña, manteca de cacao, sal de Salinas de Guaranda. Vegano, sin gluten.',
    ...
    cafe: { title: 'Café de Loja 65 %', eyebrow: 'Sabor andino · Guayas + Loja · 50 g', price: '$4.50', badge: '', award: '', variant: 'milk', conch: '40 h', ingr: 'Cacao Nacional, azúcar de caña, café de Loja, manteca de cacao. Vegano, sin gluten.',
    ...
    lote: { title: 'Lote 09 · Nacional 70 %', eyebrow: 'Lote numerado · 100 g · 300 unidades', price: '$30.00', badge: '300 unidades · firmada', award: 'Del mismo lote que ganó Oro [DATO RIGHTS]', variant: 'dark', conch: '48 h', ingr: 'Cacao Nacional, azúcar de caña, manteca de cacao. Faja numerada y firmada por el maestro que la templó.',
